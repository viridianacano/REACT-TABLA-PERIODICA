...
function App() {
  ...
  return (
    <div className="App">
      <div className="row">
      {
        row1.map( ( {nombre, simbolo, grupo, id} ) => 
          <Element key={id} name={nombre} symbol={simbolo} group={grupo}/> 
        )
      }
      </div>
      ...
      <div className="row">
        ...
        {
          row2_1.map( ( {nombre, simbolo, grupo, id} ) => 
            <Element key={id} name={nombre} symbol={simbolo} group={grupo}/> 
          )
        }
        </div>
        ...
        <div className="sub-row">
        {
          row2_2.map( ( {nombre, simbolo, grupo, id} ) => 
            <Element key={id} name={nombre} symbol={simbolo} group={grupo}/> 
          )
        }
        </div>
      ...
      <div className="row">
        <div className="sub-row">
        {
          row3_1.map( ( {nombre, simbolo, grupo, id} ) => 
            <Element key={id} name={nombre} symbol={simbolo} group={grupo}/> 
          )
        }
        </div>
        ...
        <div className="sub-row">
        {
          row3_2.map( ( {nombre, simbolo, grupo, id} ) => 
            <Element key={id} name={nombre} symbol={simbolo} group={grupo}/> 
          )
        }
        </div>
